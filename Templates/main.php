...
<head>
    ...
    ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo ASSETS.'css/miestilos.css';
    ?>">
     <link rel="stylesheet" type="text/css" href="<?php echo ASSETS.'css/estilosNav.css';
    ?>">
     <link rel="stylesheet" type="text/css" href="<?php echo ASSETS.'css/estilosVideos.css';
    ?>">
</head>
...
<script type="text/javascript" src="<?php echo ASSETS.'js/navfunctions.js'; ?>"></script>
<script type="text/javascript" src="<?php echo ASSETS.'js/validationpass.js'; ?>"></script>
<script src="https://kit.fontawesome.com/8e8ffdb433.js" crossorigin="anonymous"></script>
